...
//       uima::lowlevel::FSHeap::TyFSHeap const & tyTempHeap = crHeap.iv_clTemporaryHeap;
    ...
    // add contentEntry for baseCAS ... point non-compliant annotations at first Sofa
    sofaRefMap.push_back(1);
    // add contentEntry for baseCAS ... _indexed=0 stays in 0
...
// ---------------------------------------------------------------------------
  ...
  void XCASDeserializerHandler::characters(
    ...
    //cout << "XCASDeserializerHandler::characters: \"" << UnicodeString(cpwsz, uiLength) << "\"" << endl;
