...
namespace uima {
  ...
  public:
    ...
    void setStringValue(Feature const & crFeature, UnicodeString const & crustr );
    ...
    void setStringValueExternal(Feature const & crFeature,  UnicodeString const & crustr );
...
namespace uima {
  ...
  inline void FeatureStructure::setStringValue(Feature const & crFeature, UnicodeString const & crustr ) {
  ...
  inline void FeatureStructure::setStringValueExternal(Feature const & crFeature,  UnicodeString const & crustr ) {
