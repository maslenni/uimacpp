...
//   void updateAndIndexDocumentAnnotation();
  ...
  protected:
     ...
     */
    int addString(UnicodeString const & crString);
  ...
  public:
    ...
    *             call getSofa() if you truly need to access the SofaFS object.
     ...
     */
    CAS* getView(const UnicodeString & localViewName);
     ...
     */
    CAS * createView(UnicodeString const & localViewName);
     ...
     *              If the Sofa data has already been set, or View is base CAS.
     */
    virtual void setSofaDataString(UnicodeStringRef const text, UnicodeString const & mimetype);
     ...
     *              If the Sofa data has already been set, or View is base CAS.
     */
    virtual void setSofaDataArray(FeatureStructure array, UnicodeString const & mime);
     ...
     *              If the Sofa data has already been set, or View is base CAS.
     */
    virtual void setSofaDataURI(UnicodeString const & uri, UnicodeString const & mime);
    ...
    * This is called by the framework automatically; users do not need to call it.
     ...
     * @{ */
    UnicodeString getAnnotationIndexID() const {
      return UnicodeString(CAS::INDEXID_ANNOTATION);
    }
    /** @} */
     ...
     */
    static UnicodeString const ustrCREATOR_ID_CAS;
    /** @} defgroup */
  };
  ...
  protected:
     ...
     */
    void setSofaMime(UnicodeString const & aString);
  ...
  public:
    ...
    void setRemoteSofaURI(UnicodeString const & aString);
