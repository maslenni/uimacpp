...
/**
  ...
  protected:
    void normalize(UnicodeStringRef const & in, UnicodeString& out) const;
  public:
...
**/
  ...
  private:
    ...
    UnicodeString getTab(int tab) const;
    void writeFS(int tab, std::ostream& os, lowlevel::TyFS, bool bWriteShortStyle) const;
    void writeArray(int iTab, std::ostream& os, lowlevel::TyFSFeature & tyFeat, lowlevel::TyFS & tyValue, lowlevel::TyFSType tyRange, UnicodeString & newTab) const;
  public:
