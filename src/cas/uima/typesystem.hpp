...
namespace uima {
    ...
    public:
         ...
         * @throws InvalidFSTypeObjectException
         */
        Feature getFeatureByBaseName(UnicodeString const &crBaseName) const;
    ...
    public:
         ...
         */
        Feature getFeatureByFullName(UnicodeString const &crName) const;
         ...
         */
        Type getType(UnicodeString const &crName) const;
