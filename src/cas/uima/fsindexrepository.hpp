...
namespace uima {
  ...
  public:
     ...
     */
    FSIndex getIndex(UnicodeString const & crLabel) const;
     ...
     */
    FSIndex getIndex(UnicodeString const & crLabel, Type const & crType) const;
     ...
     */
    std::vector<UnicodeString> getAllIndexIDs() const;

    /**
     * get the most general type where the index is defined.
     */
    Type getTypeForIndex(UnicodeString const & ) const;

    /**
     * check if there exists an index with ID <code>crID</code>.
     */
    bool isValidIndexID(UnicodeString const & crID) const;

    /**
     * check if there exists an index with ID <code>id</code> for type
     * <code>crType</code>.
     */
    bool isValidIndexID(UnicodeString const & crID, Type const & crType) const;
