...
*/
    ...
    private:
      ...
      /**
       * helper function to set the string ref heap contentEntry located
    ...
    public:
       ...
       * @return the reference to the copied string.
       */
      int addString(UnicodeString const & uls) {
      ...
      * where values of this array type is stored.
       ...
       * This method is non-const since an contentEntry on the string ref heap
       * is created.
       */
...
namespace uima {
  namespace lowlevel {
    ...
    inline int FSHeap::getIntValue(TyFS tyFs, TyFSFeature tyFeature) const {
      assert( iv_rclTypeSystem.isValidFeature(tyFeature) );
      assert( iv_rclTypeSystem.getTypeName( iv_rclTypeSystem.getRangeType(tyFeature) )  == UnicodeString(CAS::TYPE_NAME_INTEGER) );
    ...
    inline float FSHeap::getFloatValue(TyFS tyFs, TyFSFeature tyFeature) const {
      assert( iv_rclTypeSystem.isValidFeature(tyFeature) );
      assert( iv_rclTypeSystem.getTypeName( iv_rclTypeSystem.getRangeType(tyFeature) )  == UnicodeString(CAS::TYPE_NAME_FLOAT) );
      assertWithMsg( sizeof(float) <= sizeof(TyHeapCell*), "Port required");
      TyFS tyResult = getFeatureInternal(tyFs, tyFeature);
...
//////////////////////////////////////////////////////////////////////////
    ...
    inline void FSHeap::setBooleanValue(TyFS tyFs, TyFSFeature tyFeature, bool ref) {
      assert( iv_rclTypeSystem.isValidFeature(tyFeature) );
      assert( iv_rclTypeSystem.getTypeName( iv_rclTypeSystem.getRangeType(tyFeature) )  == UnicodeString(CAS::TYPE_NAME_BOOLEAN) );
      assertWithMsg( sizeof(int) <= sizeof(TyHeapCell*), "Port required");
    ...
    inline void FSHeap::setByteValue(TyFS tyFs, TyFSFeature tyFeature, char ref) {
      assert( iv_rclTypeSystem.isValidFeature(tyFeature) );
      assert( iv_rclTypeSystem.getTypeName( iv_rclTypeSystem.getRangeType(tyFeature) )  == UnicodeString(CAS::TYPE_NAME_BYTE) );
      assertWithMsg( sizeof(int) <= sizeof(TyHeapCell*), "Port required");
      setFeatureInternal(tyFs, tyFeature, getAsFS(ref) );
    }
    ...
    inline void FSHeap::setShortValue(TyFS tyFs, TyFSFeature tyFeature, short ref) {
      assert( iv_rclTypeSystem.isValidFeature(tyFeature) );
      assert( iv_rclTypeSystem.getTypeName( iv_rclTypeSystem.getRangeType(tyFeature) )  == UnicodeString(CAS::TYPE_NAME_SHORT) );
      assertWithMsg( sizeof(int) <= sizeof(TyHeapCell*), "Port required");
      setFeatureInternal(tyFs, tyFeature, getAsFS(ref) );
    }
    ...
    inline void FSHeap::setLongValue(TyFS tyFs, TyFSFeature tyFeature, INT64 ref) {
      assert( iv_rclTypeSystem.isValidFeature(tyFeature) );
      assert( iv_rclTypeSystem.getTypeName( iv_rclTypeSystem.getRangeType(tyFeature) )  == UnicodeString(CAS::TYPE_NAME_LONG) );
      assertWithMsg( sizeof(int) <= sizeof(TyHeapCell*), "Port required");
    ...
    inline void FSHeap::setDoubleValue(TyFS tyFs, TyFSFeature tyFeature, double ref) {
      assert( iv_rclTypeSystem.isValidFeature(tyFeature) );
      assert( iv_rclTypeSystem.getTypeName( iv_rclTypeSystem.getRangeType(tyFeature) )  == UnicodeString(CAS::TYPE_NAME_DOUBLE) );
      assertWithMsg( sizeof(int) <= sizeof(TyHeapCell*), "Port required");
