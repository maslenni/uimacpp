...
private:
   ...
   */
//   static void throwNewInternalException(JNIEnv* jeEnv,UnicodeString errorMessage);
  /**
...
public:
  ...
  */
  ...
  static void createStringVector(JNIEnv* jeEnv, jobjectArray, std::vector<uima::UnicodeStringRef> & rResult, std::vector<UnicodeString> & );
