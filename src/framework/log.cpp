...
namespace uima {
  ...
  void LogFacility::log(LogStream::EnEntryType enType, const UnicodeString & ustrMsg, long lUserCode) const
  /* ----------------------------------------------------------------------- */
  {
    string strMsg;
  ...
  LogFacility::LogFacility(UnicodeString const & crEngineName):
      iv_lLastUserCode(0),
