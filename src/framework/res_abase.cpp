...
namespace uima {
    ...
    ResourceABase::ResourceABase(UnicodeString const& crKey, UnicodeString const& crKind)
            : iv_key(crKey),
              iv_kind(crKind) { }
    ...
    void ResourceABase::setNewKey(UnicodeString const& crNewKey) {
        iv_key = crNewKey;
    }

    void FileResource::resolveFilename() {
        UnicodeString file = getKey();
        file.append(".");
        file.append(getKind());
    ...
    FileResource::FileResource(UnicodeString const& crKey,
    ...
    LanguageKindFileResource::LanguageKindFileResource(UnicodeString const& crKey,
                                                       UnicodeString const& crKind,
    ...
    void LanguageKindFileResource::resolveFilename() {
        ...
        char buf[bufLen];
        UnicodeString const& crKey = getKey();
    ...
    ResourceFactoryABase::ResourceFactoryABase(UnicodeString const& crKind)
            : iv_kind(crKind) { }
    ...
    LanguageKindFileResourceFactory::LanguageKindFileResourceFactory(UnicodeString const& crKind,
                                                                     bool bTryAlternativeTerritories)
