...
#define NUM_COMPATIBLE_UIMA_JAVA_VERSIONS 2
        ...
        private:
            ...
            std::vector<UnicodeString> iv_stringPool;
            ...
            * TyCreateJavaVMFunc)(JavaVM**, void**, void*);
            typedef jint (JNICALL
            * TyGetCreatedJavaVMsFunc)(JavaVM**, jsize, jsize*);
            ...
            // handle JNI Error (1)
            void handleJNIError(jint rc, UnicodeString const&);
            ...
            void createStringVector(jobjectArray ar, std::vector<UnicodeStringRef>& result,
                                    std::vector<UnicodeString>& pool);
