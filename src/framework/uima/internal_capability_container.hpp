...
namespace uima {
    ...
    namespace internal {
        ...
        public:
             ...
             */
            void init(std::vector<Capability*> const& vecCap, TypeSystem const& typeSystem,
                      EnMatchPolicy enMatchPolicy = enStrictThenLooseMatch);
        ...
        private:
            ...
            /* tool function that checks if a special contentEntry for the unspecified
