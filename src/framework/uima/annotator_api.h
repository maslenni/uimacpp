...
UIMA_ANNOTATOR_LINK_IMPORTSPEC uima::TyErrorId UIMA_ANNOTATOR_LINK_SPEC tafAnnotatorInit(uima::AnnotatorContext&,
                                                                                         uima::TyHandle);
UIMA_ANNOTATOR_LINK_IMPORTSPEC uima::TyErrorId UIMA_ANNOTATOR_LINK_SPEC tafAnnotatorDeInit(uima::TyHandle);
UIMA_ANNOTATOR_LINK_IMPORTSPEC uima::TyErrorId UIMA_ANNOTATOR_LINK_SPEC tafAnnotatorTypeSystemInit(
        uima::TypeSystem const&, uima::TyHandle);
UIMA_ANNOTATOR_LINK_IMPORTSPEC uima::TyErrorId UIMA_ANNOTATOR_LINK_SPEC tafAnnotatorProcessDocument(uima::CAS&,
                                                                                                    const uima::ResultSpecification&,
                                                                                                    uima::TyHandle);
UIMA_ANNOTATOR_LINK_IMPORTSPEC uima::TyErrorId UIMA_ANNOTATOR_LINK_SPEC tafAnnotatorReConfig(uima::TyHandle);
UIMA_ANNOTATOR_LINK_IMPORTSPEC uima::TyErrorId UIMA_ANNOTATOR_LINK_SPEC tafAnnotatorBatchProcessComplete(
        uima::TyHandle);
UIMA_ANNOTATOR_LINK_IMPORTSPEC uima::TyErrorId UIMA_ANNOTATOR_LINK_SPEC tafAnnotatorCollectionProcessComplete(
        uima::TyHandle);
...
UIMA_ANNOTATOR_LINK_IMPORTSPEC int            UIMA_ANNOTATOR_LINK_SPEC tafAnnotatorGetCasInstancesRequired(
        uima::TyHandle);
