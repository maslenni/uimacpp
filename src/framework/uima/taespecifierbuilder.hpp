...
namespace uima {
  ...
  private:
    ...
    AnalysisEngineMetaData * buildAEMetaData(DOMElement * specElem, UnicodeString const &);
	...
	void buildTypeSystemSpecifier(TypeSystemDescription & tsDesc, DOMElement* specElem,const UnicodeString & xmlFileLoc);
    ...
    UnicodeString convert( XMLCh const * cpUCBuf ) const;
    UnicodeString getSpannedText(DOMNode * node);
    DOMNode * findFirst(DOMNodeList * nodes, char const * tagName);
    DOMElement * findFirstElementNode(DOMNodeList * nodes);
    bool isTrue(const UnicodeString & value) const;
  ...
  public:
    ...
    void buildTae(AnalysisEngineDescription & taeSpec, DOMElement * specElem,
                  const UnicodeString & xmlFileLoc);
     /**@deprecated*/
    void buildTaeFromFile(AnalysisEngineDescription & taeSpec, UnicodeString const & fileName);
     /**@deprecated*/ 
	void buildTaeFromFile(AnalysisEngineDescription & taeSpec, char const * fileName);
	 /**@deprecated*/
	void buildTaeFromMemory(AnalysisEngineDescription & taeSpec, UnicodeString const & xmlString);
     /**@deprecated*/
    ...
    TypeSystemDescription * buildTypeSystemSpecifierFromFile(char const * filename);
     /**@deprecated*/
	TypeSystemDescription * buildTypeSystemSpecifierFromFile(UnicodeString const & fileName);
     /**@deprecated*/
	TypeSystemDescription * buildTypeSystemSpecifierFromMemory(UnicodeString const & xmlString);
     /**@deprecated*/
    ...
    void buildConfigParamSettings(AnalysisEngineMetaData & aeDesc, DOMElement * specElem);
     /**@deprecated*/
    void buildTypePriorities(AnalysisEngineMetaData & aeDesc, DOMElement * specElem, UnicodeString const & xmlFileLoc, std::vector<UnicodeString> & alreadyImported);
     /**@deprecated*/
