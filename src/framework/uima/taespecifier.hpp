...
namespace uima {
    ...
    **/
    ...
    public:
        ...
        TyErrorId setFeatureName(const UnicodeString& feature) {
            if (!isModifiable()) {
        ...
        const UnicodeString& getFeatureName() const {
    ...
    **/
    ...
    public:
        ...
        TyErrorId setLabel(const UnicodeString& name) {
            if (!isModifiable()) {
                return UIMA_ERR_CONFIG_OBJECT_COMITTED;
            }
            iv_label = name;
        ...
        TyErrorId setTypeName(const UnicodeString& name) {
            if (!isModifiable()) {
                return UIMA_ERR_CONFIG_OBJECT_COMITTED;
            }
            iv_typeName = name;
        ...
        const UnicodeString& getTypeName() const {
            return (iv_typeName);
        }
    ...
    private:
        ...
        UnicodeString iv_label;
        UnicodeString iv_typeName;
        EnIndexKind iv_kind;
    ...
    **/
    ...
    public:
        ...
        **/
        ...
        virtual std::vector<UnicodeString> const& getNodes() const = 0;

        virtual TyErrorId addNode(const UnicodeString& node) = 0;
    ...
    **/
    ...
    public:
        ...
        * <code>node</code> must uniquely identify an annotator.
        **/
        TyErrorId addNode(const UnicodeString& node) {
            if (!isModifiable()) {
                return UIMA_ERR_CONFIG_OBJECT_COMITTED;
            }
        ...
        std::vector<UnicodeString> const& getNodes() const {
            return (iv_nodes);
        }

    private:
        EnFlowType iv_type;
        std::vector<UnicodeString> iv_nodes;
    };
    ...
    public:
        ...
        typedef std::map<UnicodeString, ConfigurationGroup> TyConfigGroup;
        typedef std::map<UnicodeString, SettingsForGroup> TyConfigSettings;
        ...
        **/
        ...
        TyErrorId setName(const UnicodeString& name) {
            if (!isModifiable()) {
                return UIMA_ERR_CONFIG_OBJECT_COMITTED;
            }
            iv_name = name;
        ...
        TyErrorId setDescription(const UnicodeString& desc) {
            if (!isModifiable()) {
                return UIMA_ERR_CONFIG_OBJECT_COMITTED;
            }
            iv_description = desc;
        ...
        TyErrorId setVersion(const UnicodeString& version) {
            if (!isModifiable()) {
                return UIMA_ERR_CONFIG_OBJECT_COMITTED;
            }
            iv_version = version;
        ...
        const UnicodeString& getVersion() const {
            return (iv_version);
        }

        TyErrorId setVendor(const UnicodeString& vendor) {
            if (!isModifiable()) {
                return UIMA_ERR_CONFIG_OBJECT_COMITTED;
            }
            iv_vendor = vendor;
        ...
        const UnicodeString& getVendor() const {
            return (iv_vendor);
        }
        ...
        **/
        TyErrorId setDefaultGroupName(const UnicodeString& groupName);
        ...
        **/
        const UnicodeString& getGroupNameWhenNotSpec() const;
        ...
        **/
        NameValuePair* getNameValuePair(const UnicodeString& paramName,
                                        const UnicodeString& ancKey = UnicodeString(""));
        ...
        * Otherwise, return NULL
        **/
        NameValuePair* getNameValuePair(const UnicodeString& groupName,
        ...
        **/
         ...
         */
        bool isParameterDefined(const UnicodeString& paramName,
        ...
        **/
        const std::vector<UnicodeString> getGroupNamesForParameter(const UnicodeString& paramName) const;
    ...
    private:
        ...
        const UnicodeString& getDefaultGroupName() const {
        ...
        **/
        /*       NameValuePair * getNameValuePairPtr(const UnicodeString & paramName) {  */
        ...
        * Otherwise, return NULL
        **/
        NameValuePair* getNameValuePairPtr(const UnicodeString& groupName,
                                           const UnicodeString& paramName);
        ...
        **/
        NameValuePair* getNameValuePairNoFallback(const UnicodeString& groupName,
                                                  const UnicodeString& paramName,
        ...
        **/
        void generateFallbackGroups(const UnicodeString& groupName,
                                    EnSearchStrategy strategy,
                                    std::vector<UnicodeString>& fallbackGroups);

        /**
        * Adds a configuration group named <code>groupName</code>.
        * Throws an exception if the group already exists
        **/
        TyErrorId addConfigurationGroup(const UnicodeString& groupName);
        ...
        * it will be deleted when this object's destructor is called !
        **/
        TyErrorId addConfigurationParameter(const UnicodeString& groupName,
        ...
        * for the group.
        **/
        void addNameValuePair(const UnicodeString& groupName,
                              NameValuePair* nvPair);

        /**
        * @return The names of all groups defined in this <code>AnalysisEngineMetaData</code>
        * object. If there are no groups defined, the vector contains only one contentEntry,
        ...
        *
        **/
        const std::vector<UnicodeString> getConfigurationGroupNames() const;
        ...
        **/
        const std::vector<const ConfigurationParameter*> getConfigurationParameters(
                const UnicodeString& groupName) const;
        ...
        UnicodeString CONFIG_GROUP_NAME_WHEN_NO_GROUPS;
        //internally, the common parameters are just another configuration group
        UnicodeString CONFIG_GROUP_NAME_COMMON_PARMS;

        //typedef map <UnicodeString, ConfigurationGroup> TyConfigGroup;
        //typedef map <UnicodeString, SettingsForGroup> TyConfigSettings;
        UnicodeString iv_name;
        UnicodeString iv_description;
        UnicodeString iv_version;
        UnicodeString iv_vendor;
        UnicodeString iv_defaultGroup;
        bool iv_hasGroups;
    ...
    **/
    ...
    public:
        ...
        typedef std::map<UnicodeString, AnalysisEngineDescription*> TyMapDelegateSpecs;
        ...
        **/
        const UnicodeString& getAnnotatorImpName() const {
            return iv_annotatorImpName;
        }

        void setXmlFileLocation(const UnicodeString xmlLoc) {
        ...
        */
        const UnicodeString& getXmlFileLocation() const {
            return iv_xmlFileLoc;
        }

        void setXmlRootTag(const UnicodeString xmlTag) {
        ...
        * returns some buffer ID generated by Xerces
        */
        const UnicodeString& getXmlRootTag() const {
        ...
        * it will be deleted when this object's destructor is called !
        **/
        TyErrorId addDelegate(const UnicodeString& key,
        ...
        **/
        AnalysisEngineDescription* getDelegate(const UnicodeString& key) const;
        ...
        * Returns NULL if no delegate can be found for key
        **/
        AnalysisEngineDescription* extractDelegate(const UnicodeString& key);
        ...
        **/
         ...
         */
        void toXMLBuffer(UnicodeString&) const;

        void toXMLBuffer(AnalysisEngineMetaData const& md,
                         bool isCasConsumer,
                         UnicodeString& s) const;
        ...
        TyErrorId setAnnotatorImpName(const UnicodeString& anName) {
            if (!isModifiable()) {
                return UIMA_ERR_CONFIG_OBJECT_COMITTED;
            }
    ...
    private:
        ...
        void toXMLBufferNoXMLHeader(UnicodeString& s) const;

        void appendConfigGroupToXMLBuffer(ConfigurationGroup const& config, UnicodeString& s) const;

        void appendConfigGroupSettingsToXMLBuffer(SettingsForGroup const& settings, UnicodeString& s) const;

        bool iv_bPrimitive;
        EnFrameworkImplName iv_enFrameImpl;
        UnicodeString iv_annotatorImpName;


        //If the AnalysisEngineDescription was built from an xml file, contains the
        //path to the file on the file system
        UnicodeString iv_xmlFileLoc;
        UnicodeString iv_xmlRootTag;
