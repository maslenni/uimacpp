...
//lint -e1714 -e1914 -e1526 -e1931 -e754
    ...
    class UIMA_LINK_IMPORTSPEC AnnotatorLanguageMatch
            : public unary_function<AnnotatorFile, bool> {                                                 //lint !e1932
    public:
    ...
    /** we need this class for the STL find_if() procedure */
    class UIMA_LINK_IMPORTSPEC AnnotatorStrictLanguageMatch
            : public unary_function<AnnotatorFile, bool> {                                                 //lint !e1932
    public:
