...
namespace uima {
    ...
    public:
         ...
         */
        TyErrorId setLocation(const UnicodeString& aUri) {
            if (!isModifiable()) {
        ...
        * This will be located by appending ".xml" to the name and searching the classpath.
        ...
        TyErrorId setName(const UnicodeString& aname) {
            if (!isModifiable()) {
                return UIMA_ERR_CONFIG_OBJECT_COMITTED;
            }
            iv_name = aname;
        ...
        * This will be located by appending ".xml" to the name and searching the classpath.
        ...
        const UnicodeString findAbsoluteUrl(UnicodeString const& lastFilename) {
