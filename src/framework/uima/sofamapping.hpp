...
namespace uima {
  ...
  **/
  ...
  public:
     ...
     */
    TyErrorId setComponentKey(const UnicodeString & componentKey) {
      if (! isModifiable()) {
     ...
     */
    const UnicodeString & getComponentKey() const {
    ...
    TyErrorId setComponentSofaName(const UnicodeString & componentSofaName) {
      if (! isModifiable()) {
        return UIMA_ERR_CONFIG_OBJECT_COMITTED;
      }
    ...
    const UnicodeString & getComponentSofaName() const {
    ...
    TyErrorId setAggregateSofaName(const UnicodeString & aggregateSofaName) {
      if (! isModifiable()) {
        return UIMA_ERR_CONFIG_OBJECT_COMITTED;
      }
     ...
     */
    const UnicodeString & getAggregateSofaName() const {
  ...
  private:
    ...
    UnicodeString iv_componentKey;
    UnicodeString iv_componentSofaName;
    UnicodeString iv_aggregateSofaName;
