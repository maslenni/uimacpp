...
namespace uima {
     ...
     * The member functions are named to implement the UnicodeString interface
    ...
    public:
         ...
         */
        UnicodeStringRef(const UnicodeString& crUniString);
...
namespace uima {
    ...
    inline UnicodeStringRef::UnicodeStringRef(
            const UnicodeString& crUniString
    ) :
...
//========================================
    ...
    inline int8_t
            UnicodeStringRef::compare(UnicodeString const
    &src ) const {
    return doCompare(0, iv_uiLength, src.
...
UnicodeStringRef::doCaseCompare(int32_t start,
                                ...
                                int32_t srcLength,
                                uint32_t options) const {
    UnicodeString s(iv_pUChars + start, (int32_t) length);
...
delimitedUnicodeStringRef2Vector(
    ...
    return delimitedUnicodeStringRef2Vector(veclstrOutput, pcInput, u_strlen(pcInput), cpszDelimiters, bTrimString,
                                            bInsertEmptyStrings);
}
