...
namespace uima {
    ...
    */
    ...
    public:
        ...
        **/
        TyErrorId addRestriction(const UnicodeString& delegateName) {
            if (!isModifiable()) {
                return UIMA_ERR_CONFIG_OBJECT_COMITTED;
            }
        ...
        bool isDefinedForAnnotatorContext(const UnicodeString& ancKey) const;
        ...
        **/
        /*       const std::vector<UnicodeString> & getRestrictions() const{ */
    ...
    private:
        ...
        bool iv_mandatory;
        std::vector<UnicodeString> iv_vecRestrictedToDelegates;
    ...
    **/
    ...
    public:
        typedef std::vector<UnicodeString> TyStrValueList;
        ...
        **/
        ...
        void define(ConfigurationParameter::EnParameterType type,
        ...
        TyErrorId setValue(const UnicodeString& value);
        ...
        TyErrorId addValue(const UnicodeString& value);
        ...
        UnicodeString const& extractStringValue() const;

        std::vector<UnicodeString> const& extractStringValues() const;
    ...
    private:
        ...
        std::string convert(const UnicodeString& value) const;
    ...
    **/
    ...
    public:
        ...
        void commit() {
            std::map<UnicodeString, ConfigurationParameter*>::iterator entries;
        ...
        **/
        bool hasConfigurationParameter(const UnicodeString& paramName) const {
            std::map<UnicodeString, ConfigurationParameter*>::const_iterator ite = iv_configParams.find(paramName);
        ...
        **/
        const ConfigurationParameter* getConfigurationParameter(const UnicodeString& paramName) const {
            std::map<UnicodeString, ConfigurationParameter*>::const_iterator ite = iv_configParams.find(paramName);
    ...
    private:
        std::map<UnicodeString, ConfigurationParameter*> iv_configParams;
    ...
    **/
    ...
    public:
        ...
        ~SettingsForGroup() {
            std::map<UnicodeString, NameValuePair*>::iterator entries = iv_nameValuePairs.begin();
        ...
        **/
        NameValuePair* getNameValuePair(const UnicodeString& paramName) const {
            std::map<UnicodeString, NameValuePair*>::const_iterator ite = iv_nameValuePairs.find(paramName);
    ...
    private:
        std::map<UnicodeString, NameValuePair*> iv_nameValuePairs;
    };
