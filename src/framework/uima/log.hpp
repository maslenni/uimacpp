...
namespace uima {
    ...
    public:
        ...
        *   of the  LogFacility for each annotator. */
        LogFacility(UnicodeString const&);
        ...
        LogFacility(UnicodeString const&, LogStream::EnEntryType level);
        ...
        /** Log the specified message together with a user-defined id. */
        void logMessage(const UnicodeString& crclMessage, long lUserCode = 0) const;
        ...
        /** Log the specified warning together with a user-defined id. */
        void logWarning(const UnicodeString& crclMessage, long lUserCode = 0) const;
        ...
        /** Log the specified error together with a user-defined id. */
        void logError(const UnicodeString& crclMessage, long lUserCode = 0) const;
    ...
    private:
        ...
        void log(LogStream::EnEntryType enType, const UnicodeString& crclMessage, long lUserCode = 0) const;
    ...
    /**
     * Use this define to write a single statement log contentEntry using streams
     * @see LogFacility
     */
#define UIMA_LOG_STREAM(logFacility, logEntryType, args)       \
   {                                                          \
    ...
    /**
     * Use this define to write a single statement message log contentEntry using streams
     * @see LogFacility
     */
#define UIMA_LOG_STREAM_MESSAGE(logFacility, args) \
   UIMA_LOG_STREAM(logFacility, LogStream::EnMessage, args);
    ...
    /**
     * Use this define to write a single statement warning log contentEntry using streams
     * @see LogFacility
     */
#define UIMA_LOG_STREAM_WARNING(logFacility, args) \
   UIMA_LOG_STREAM(logFacility, LogStream::EnWarning, args);
    ...
    /**
     * Use this define to write a single statement error contentEntry using streams
     * @see LogFacility
     */
...
namespace uima {
    ...
    inline void LogFacility::logMessage(const UnicodeString& crclMessage, long lUserCode) const
    /* ----------------------------------------------------------------------- */
    {
    ...
    inline void LogFacility::logWarning(const UnicodeString& crclMessage, long lUserCode) const
    /* ----------------------------------------------------------------------- */
    {
    ...
    inline void LogFacility::logError(const UnicodeString& crclMessage, long lUserCode) const
    /* ----------------------------------------------------------------------- */
    {
