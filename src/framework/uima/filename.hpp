...
namespace uima {
    namespace util {
        ...
        public:
            ...
            /** assign a new contentEntry from a path, optional filename and optional extension. */
        ...
        inline void Filename::setNewName(const char* cpszName) {
            ...
            // and create a new contentEntry by concatenating new filename.
        ...
        inline void Filename::setNewExtension(const char* cpszExtension) {
            ...
            // remove old and create a new contentEntry by concatenating new extension.
