...
namespace uima {
    ...
    public:
         ...
         * created.
         */
        ResourceABase const* getResource(UnicodeString const& crKey,
                                         ResourceFactoryABase const& crFactory,
                                         ErrorInfo&);
         ...
         */
        void registerFactory(UnicodeString const& crKind, ResourceFactoryABase& crFactory);

        /**
         * Deregister a factory for a given kind of ressource.
         */
        void deRegisterFactory(UnicodeString const& crKind, ResourceFactoryABase& crFactory);
        ...
        static UnicodeString resolveFilename(UnicodeString const& filename,
    ...
    private:
        ...
        typedef std::map<UnicodeString, TyResourceList> TyResources;
        TyResources iv_resources;

        typedef std::map<UnicodeString, ResourceFactoryABase*> TyResourceFactories;
