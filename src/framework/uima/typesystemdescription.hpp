...
namespace uima {
  ...
  **/
  ...
  public:
    ...
    TyErrorId setDescription(const UnicodeString &  description) {
      if (! isModifiable()) {
        return UIMA_ERR_CONFIG_OBJECT_COMITTED;
      }
  ...
  **/
  ...
  public:
    ...
    TyErrorId setName(const UnicodeString & featName) {
      if (! isModifiable()) {
        return UIMA_ERR_CONFIG_OBJECT_COMITTED;
      }
      iv_name = featName;
    ...
    TyErrorId setRangeTypeName(const UnicodeString & rangeName) {
      if (! isModifiable()) {
        return UIMA_ERR_CONFIG_OBJECT_COMITTED;
      }
    ...
    const UnicodeString & getRangeTypeName() const {
      return iv_rangeType;
    }

    TyErrorId setElementType(const UnicodeString & elementName) {
      if (! isModifiable()) {
        return UIMA_ERR_CONFIG_OBJECT_COMITTED;
      }
    ...
    const UnicodeString & getElementType() const {
  ...
  private:
    UnicodeString iv_name;
    UnicodeString iv_description;
    UnicodeString iv_rangeType;
    UnicodeString iv_elementType;
  ...
  **/
  ...
  public:
    ...
    TyErrorId setSuperTypeName(const UnicodeString & name) {
      if (! isModifiable()) {
        return UIMA_ERR_CONFIG_OBJECT_COMITTED;
      }
    ...
    const UnicodeString & getSuperTypeName() const {
    ...
    **/
    FeatureDescription * getFeatureDescription(const UnicodeString & featureName) const;

    AllowedValue * getAllowedValue(const UnicodeString & name) const;
  ...
  private:
    ...
    UnicodeString iv_superTypeName;
    UnicodeString iv_description;
  ...
  * that is, if contentEntry b comes after contentEntry a in the list, then a as a higher
  * priority than b.
  **/
  ...
  public:
    ...
    TyErrorId addType(const UnicodeString & type) {
      if (! isModifiable()) {
        return UIMA_ERR_CONFIG_OBJECT_COMITTED;
      }
    ...
    const std::vector <UnicodeString> & getTypeOrder() const {
      return iv_vecTypeOrder;
    }

  private:
    std::vector <UnicodeString> iv_vecTypeOrder;
  };
  ...
  **/
  ...
  public:
    ...
    void commit() {
      ...
      std::vector<UnicodeString> alreadyImportedLocations;
    ...
    **/
    ...
    TypeDescription * getTypeDescription(const UnicodeString & typeName) const;

    const TypeDescription * getTypeDescriptionConst(const UnicodeString & typeName) const {
      return getTypeDescription(typeName);
    }

    bool hasTypeDescription(const UnicodeString & typeName) const {
    ...
    */
    ...
    TyErrorId resolveImports(std::vector<UnicodeString> & alreadyImportedTypeSystemLocations);

    TyErrorId resolveImport(const UnicodeString & fileLocation,
