...
namespace uima {
    namespace util {
           ...
           foo(const Location & crclLocation, bool bRecurseSubdirs)
           {
              ...
              while(clDirWalk.isValid())
                 ...
                 if(clDirWalk.isDirectory())
                    cout << "Directory contentEntry: " << clDirWalk.getNameWithoutPath();
                 else
                    if(clDirWalk.isFile())
        ...
        public:
            ...
            /** @name Properties */
            /*@{*/
            /** return TRUE if the current contentEntry is a valid directory contentEntry */
            bool isValid(void) const {
                return haveEntry;
            }

            /** return TRUE if the current contentEntry represents a regular file contentEntry */
            bool isFile(void) const;

            /** return TRUE if the current contentEntry represents a directory contentEntry */
            bool isDirectory(void) const;

            /** return the name part of the filename of the current contentEntry */
            const char* getNameWithoutPath(void) const;

            /** return TRUE if the current contentEntry matches the specified wildcard pattern */
            bool matchesWildcardPattern(const char* cpszPattern) const;
            /*@}*/
            /** @name Miscellaneous */
            /*@{*/
            /** walk to the next directory contentEntry and return TRUE if there is one */
            bool setToNext(void);
            /*@}*/
        protected:
            /* --- functions --- */
