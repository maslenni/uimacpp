...
namespace uima {
    ...
    public:
        UnicodeString const& getKey() const {
            return iv_key;
        }

        UnicodeString const& getKind() const {
            return iv_kind;
        }

    protected:
        ResourceABase(UnicodeString const& crKey, UnicodeString const& crKind);

        virtual ~ResourceABase();

        // dont use between init() and deInit()
        void setNewKey(UnicodeString const&);
    ...
    private:
        UnicodeString iv_key;
        UnicodeString iv_kind;
    };
    ...
    protected:
        ...
        FileResource(UnicodeString const& crKey,
    ...
    protected:
        ...
        LanguageKindFileResource(UnicodeString const& crKey,
                                 UnicodeString const& crKind,
    ...
    public:
        ...
        virtual ResourceABase* createResource(UnicodeString const& crKey) const = 0;
    ...
    protected:
        ResourceFactoryABase(UnicodeString const& crKind);
    ...
    protected:
        LanguageKindFileResourceFactory(UnicodeString const& crKind,
                                        bool bTryAlternativeTerritories);
