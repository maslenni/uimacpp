...
namespace uima {
  ...
  FeatureDescription * TypeDescription::getFeatureDescription(const UnicodeString & featureName) const {
    bool found = false;
    size_t i=0;
  ...
  TypeDescription * TypeSystemDescription::getTypeDescription(const UnicodeString & typeName) const {
    bool found = false;
    size_t i=0;
  ...
  TyErrorId TypeSystemDescription::resolveImports(vector<UnicodeString> & alreadyImportedTypeSystemLocations) {
  ...
  TyErrorId TypeSystemDescription::resolveImport(const UnicodeString & fileLocation,
      vector<UnicodeString> & alreadyImportedTypeSystemLocations,
  ...
  void TypeSystemDescription::validate() {
    ...
    vector < UnicodeString > typeNames;
  ...
  AllowedValue * TypeDescription::getAllowedValue(const UnicodeString & name) const {
    bool found = false;
    size_t i=0;
  ...
  void TypeDescription::validate() {
    ...
    vector<UnicodeString> featureNames;
