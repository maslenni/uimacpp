...
namespace uima {
  ...
  public:
     ...
     */
    TyErrorId init(UnicodeString const & parserConfigFilename, CAS & cas, ErrorInfo & err);
     ...
     */
    UnicodeString const & getDocumentDelimiterTag() const;
     ...
     */
    void setDocumentDelimiterTag(UnicodeString const & tag);
     ...
     */
    vector<UnicodeString> const & getExcludedTags() const;
     ...
     * @see getExcludedTags
     */
    void setExcludedTags( vector<UnicodeString> const & tags);
     ...
     */
    Type getTypeForTag(UnicodeString const & tagName) const;
     ...
     * @see getTypeForTag
     */
    void setTypeForTag(UnicodeString const & tagName, Type type);
    ...
    void getFeatureForAttribute(
      UnicodeString const & tagName,
      UnicodeString const & attrName,
      Type     & returnedType,
     ...
     */
    EnBreakProperty
    getBreakPropertyForTag(UnicodeString const & tagName) const;
  ...
  private:
    ...
    typedef map< UnicodeString, Type, less<UnicodeString> >
    TyXMLNameToTypeMap;
    ...
    typedef map< UnicodeString, StFeatureInfo, less<UnicodeString> >
    ...
    typedef map< UnicodeString, TyXMLAttrToFeatureMap, less<UnicodeString> >
    TyXMLNameToAttrMap;

    // map holding information about XML Elements and their break properties
    typedef map< UnicodeString, EnBreakProperty, less<UnicodeString> >
    TyXMLNameToBreakMap;
    ...
    UnicodeString         iv_ustrDocumentDelimiterTag;
    vector<UnicodeString> iv_vecustrExcludedTags;
