...
namespace uima {
  ...
  public:
     ...
     * it should represent.
     */
    TypeNameSpace(uima::TypeSystem const & crTypeSystem, UnicodeString const & crName);

    /**
     * Find a type object by it's short name.
     * Implicitly this just prepends the namespace name to crTypeBaseName
     */
    Type getType(UnicodeString const & crTypeBaseName) const;

    /// Return the name of this namespace object
    UnicodeString const & getName() const;
  ...
  public:
     ...
     */
    bool getType(UnicodeString const & crRelativeTypeName, Type & rResult) const;
