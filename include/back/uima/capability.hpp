...
namespace uima {
  ...
  **/
  ...
  public:
    typedef std::vector <UnicodeString > TyVecCapabilityTofs;
    typedef std::vector <UnicodeString > TyVecCapabilityLanguages;
    typedef std::vector <UnicodeString > TyVecCapabilitySofas;
    ...
    **/
    TyErrorId addCapabilityType(const UnicodeString & type, EnTypeStyle typeStyle) {
      if (! isModifiable()) {
    ...
    **/
    TyErrorId addCapabilityFeature(const UnicodeString & feature, EnTypeStyle typeStyle) {
      if (! isModifiable()) {
        return UIMA_ERR_CONFIG_OBJECT_COMITTED;
      }
      switch (typeStyle) {
    ...
    **/
    TyErrorId addCapabilitySofa(const UnicodeString & sofa, EnTypeStyle typeStyle) {
      if (! isModifiable()) {
        return UIMA_ERR_CONFIG_OBJECT_COMITTED;
      }
      switch (typeStyle) {
    ...
    TyErrorId addSupportedLanguage(const UnicodeString & language) {
      if (! isModifiable()) {
        return UIMA_ERR_CONFIG_OBJECT_COMITTED;
      }
