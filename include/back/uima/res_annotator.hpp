...
namespace uima {
  ...
  namespace internal {
    ...
    public:
      /** @name Constructors */
      /*@{*/
      ResourceAnnotatorFile(UnicodeString const & crKey,
    ...
    public:
      ...
      virtual ResourceABase * createResource(UnicodeString const & crclKey) const;
      /*@}*/
    protected:
      /* --- functions --- */
    private:
    ...
    inline ResourceAnnotatorFile::ResourceAnnotatorFile(UnicodeString const & crKey,
        UnicodeString const & crKind)
