 ...
 * For each contentEntry in the trie, the value to be delivered is passed through
 ...
 * @param enumValue a pointer to a function that may transform the trie contentEntry value,
