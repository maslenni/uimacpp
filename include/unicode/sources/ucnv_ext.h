 ...
 * and a base table contentEntry is a prefix of a multi-character mapping, then
 * this is an error.
 *
 *
 * Implementation note:
 ...
 *   initial bytes.
 *   If the value is 0 for the initial toUTable contentEntry, then the initial byte
 ...
 *   The stage 3 granularity means that the stage 2 contentEntry needs to be left-shifted.
 *
 ...
 *   considering storing a total of 6 bytes per non-zero contentEntry in both arrays
 *   together.
