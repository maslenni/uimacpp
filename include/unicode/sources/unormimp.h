 ...
 * 16-bit words.
 * The first word of a list contentEntry is the back-index, with its bit 15 set if
 ...
 * 15   set if there is a third word in this list contentEntry
 ...
 *     each contentEntry is a pair of { code point, result } with result=(binary) yy xxxxxx xxxxxxxx
 ...
 *     either indexes to USerializedSets or single code points for
 *     single-code point sets;
 *     each contentEntry is a triplet of { high16(cp), low16(cp), result }
